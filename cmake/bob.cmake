  ...
  if (${PROJECT_NAME}_NORMAL_CXX_FLAGS)
	...
	if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
	  if (${PROJECT_NAME}_CXX_OPTIMIZE)
	    message(STATUS "setting /O2 flag!")
        set(FLAGS "${FLAGS} /O2")
      endif()
	else()
      if (${PROJECT_NAME}_CXX_OPTIMIZE)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
      ...
      if(APPLE)
        if(CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL "7.0.0")
      ...
      if(NOT APPLE)
        if(CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL "7.0.0")
          set(FLAGS "${FLAGS} -Wno-return-std-move-in-c++11")
        endif()
        if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER "7.0.0")
          set(FLAGS "${FLAGS} -Wno-return-std-move-in-c++11")
        endif()
...
function(bob_get_link_libs tgt var)
  ...
  foreach(lib IN LISTS sublibs)
    if (${lib} STREQUAL "ohEgadslite")  #HACK
    elseif (TARGET ${lib})
